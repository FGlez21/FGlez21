...
**Electronic Engineer | Cybersecurity & Digital Forensics Practitioner | IoT & Embedded Systems**

I am a technically skilled and detail-oriented professional with a background in electronics, data recovery, digital forensics, and hardware diagnostics.  
I value precision, integrity, and continuous learning. My work now focuses on cybersecurity, digital forensics, and the protection of critical systems and data.
...
## 👨‍💻 About Me
- 🇲🇽 Mexican engineer currently based in **Chicago, IL**.  
- 🔐 Transitioning into **cybersecurity**, **digital forensics**, and **OT/IT systems**.
...
Feel free to explore my work or reach out for collaboration in IoT, cybersecurity, or digital forensics.
